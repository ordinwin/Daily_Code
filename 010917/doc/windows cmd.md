...
497. Msconfig.exe：系统配置实用程序 
507. msdt：微软支持诊断工具 
517. msinfo32：系统信息 
527. mspaint：画图 
537. Msra：Windows远程协助 
547. mstsc：远程桌面连接 
557. NAPCLCFG.MSC：客户端配置 
567. ncpa.cpl：网络连接 
577. narrator：屏幕“讲述人” 
587. Netplwiz：高级用户帐户控制面板，设置登陆安全相关的选项 
597. netstat : an(TC)命令检查接口 
607. notepad：打开记事本 
617. Nslookup：IP地址侦测器 
627. odbcad32：ODBC数据源管理器 

637. OptionalFeatures：打开“打开或关闭Windows功能”对话框 


655. osk：打开屏幕键盘 
665. perfmon.msc：计算机性能监测器 
675. perfmon：计算机性能监测器 
685. PowerShell：提供强大远程处理能力 
695. printmanagement.msc：打印管理 
705. powercfg.cpl：电源选项 
715. psr：问题步骤记录器 
725. Rasphone：网络连接 
735. Recdisc：创建系统修复光盘 
745. Resmon：资源监视器 
755. Rstrui：系统还原 
765. regedit.exe：注册表 
775. regedt32：注册表编辑器 
785. rsop.msc：组策略结果集 
795. sdclt：备份状态与配置，就是查看系统是否已备份 
805. secpol.msc：本地安全策略 
815. services.msc：本地服务设置 
825. sfc /scannow：扫描错误并复原/windows文件保护 
835. sfc.exe：系统文件检查器 
845. shrpubw：创建共享文件夹 
855. sigverif：文件签名验证程序 
865. slui：Windows激活，查看系统激活信息 
875. slmgr.vbs -dlv ：显示详细的许可证信息 
...
885. snippingtool：截图工具，支持无规则截图 
895. soundrecorder：录音机，没有录音时间的限制 
905. StikyNot：便笺 
915. sysdm.cpl：系统属性 
925. sysedit：系统配置编辑器 
935. syskey：系统加密，一旦加密就不能解开，保护系统的双重密码 
945. taskmgr：任务管理器（旧版） 
955. TM任务管理器（新版） 
965. taskschd.msc：任务计划程序 
975. timedate.cpl：日期和时间 
985. UserAccountControlSettings用户账户控制设置 
995. utilman：辅助工具管理器 
